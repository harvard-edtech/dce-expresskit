        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!response || !response.body) {
                    throw new dce_reactkit_1.ErrorWithCode('We didn\'t get a response from the other server. Please check the network between the two connection.', dce_reactkit_1.CommonKitErrorCode.NoResponse);
                }
                if (!response.body.success) {
                    // Other errors
                    throw new dce_reactkit_1.ErrorWithCode((response.body.message
                        || 'An unknown error occurred. Please contact an admin.'), (response.body.code
                        || dce_reactkit_1.CommonKitErrorCode.NoCode));
                }
