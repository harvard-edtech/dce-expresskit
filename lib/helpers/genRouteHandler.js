...
var genRouteHandler = function (opts) {
    ...
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var output, crossServerScope, skipSessionCheck, requestBody, paramsToSign, err_1, paramList, i, _a, name_1, type, value, simpleVal, _b, launched, launchInfo, courseContextToken, verifiedCourseAuth, selectAdminCollection, id, match, logServerEvent, responseSent, redirect, send, renderErrorPage, renderInfoPage, renderCustomHTML, results, err_2;
            ...
            switch (_x.label) {
                ...
                case 4:
                    ...
                    for (i = 0; i < paramList.length; i++) {
                        ...
                        // Parse
                        if (type === dce_commonkit_1.ParamType.Boolean || type === dce_commonkit_1.ParamType.BooleanOptional) {
                            // Boolean
                            // Handle case where value doesn't exist
                            if (value === undefined) {
                                if (type === dce_commonkit_1.ParamType.BooleanOptional) {
                        ...
                        else if (type === dce_commonkit_1.ParamType.Float || type === dce_commonkit_1.ParamType.FloatOptional) {
                            // Float
                            // Handle case where value doesn't exist
                            if (value === undefined) {
                                if (type === dce_commonkit_1.ParamType.FloatOptional) {
                                    output[name_1] = undefined;
                                }
                                else {
                                    return [2 /*return*/, (0, handleError_1.default)(res, {
                        ...
                        else if (type === dce_commonkit_1.ParamType.Int || type === dce_commonkit_1.ParamType.IntOptional) {
                            // Int
                            // Handle case where value doesn't exist
                            if (value === undefined) {
                                if (type === dce_commonkit_1.ParamType.IntOptional) {
                                    output[name_1] = undefined;
                                }
                                else {
                                    return [2 /*return*/, (0, handleError_1.default)(res, {
                        ...
                        else if (type === dce_commonkit_1.ParamType.JSON || type === dce_commonkit_1.ParamType.JSONOptional) {
                            // Stringified JSON
                            // Handle case where value doesn't exist
                            if (value === undefined) {
                                if (type === dce_commonkit_1.ParamType.JSONOptional) {
                                    output[name_1] = undefined;
                                }
                                else {
                                    return [2 /*return*/, (0, handleError_1.default)(res, {
                        ...
                        else if (type === dce_commonkit_1.ParamType.String || type === dce_commonkit_1.ParamType.StringOptional) {
                            // String
                            // Handle case where value doesn't exist
                            if (value === undefined) {
                                if (type === dce_commonkit_1.ParamType.StringOptional) {
                                    output[name_1] = undefined;
                                }
                                else {
                                    return [2 /*return*/, (0, handleError_1.default)(res, {
                    ...
                    (!launched || !launchInfo)
                        ...
                        return [2 /*return*/, (0, handleError_1.default)(res, {
                                ...
                                code: dce_commonkit_1.CommonKitErrorCode.SessionExpired,
                                status: 401,
                            })];
                    }
                    ...
                    launchInfo
                        ...
                        return [2 /*return*/, (0, handleError_1.default)(res, {
                                ...
                                code: ExpressKitErrorCode_1.default.StudentIdMismatch,
                                status: 401,
                            })];
                    }
                    ...
                    output.userId = (launchInfo
                        ? ((_h = output.userId) !== null && _h !== void 0 ? _h : launchInfo.userId)
                        : ((_j = output.userId) !== null && _j !== void 0 ? _j : undefined));
                    output.userFirstName = (launchInfo
                        ? launchInfo.userFirstName
                        : ((_k = output.userFirstName) !== null && _k !== void 0 ? _k : undefined));
                    output.userLastName = (launchInfo
                        ? launchInfo.userLastName
                        : ((_l = output.userLastName) !== null && _l !== void 0 ? _l : undefined));
                    output.userEmail = (launchInfo
                        ? launchInfo.userEmail
                        : ((_m = output.userEmail) !== null && _m !== void 0 ? _m : undefined));
                    output.userAvatarURL = (launchInfo
                        ? ((_o = launchInfo.userImage) !== null && _o !== void 0 ? _o : 'http://www.gravatar.com/avatar/?d=identicon')
                        : ((_p = output.userAvatarURL) !== null && _p !== void 0 ? _p : undefined));
                    output.isLearner = (launchInfo
                        ? !!launchInfo.isLearner
                        : ((_q = output.isLearner) !== null && _q !== void 0 ? _q : undefined));
                    output.isTTM = (launchInfo
                        ? !!launchInfo.isTTM
                        : ((_r = output.isTTM) !== null && _r !== void 0 ? _r : undefined));
                    output.isAdmin = (launchInfo
                        ? !!launchInfo.isAdmin
                        : ((_s = output.isAdmin) !== null && _s !== void 0 ? _s : undefined));
                    output.courseId = (launchInfo
                        ? ((_t = output.courseId) !== null && _t !== void 0 ? _t : launchInfo.courseId)
                        : ((_u = output.courseId) !== null && _u !== void 0 ? _u : undefined));
                    output.courseName = (launchInfo
                        ? launchInfo.contextLabel
                        : ((_v = output.courseName) !== null && _v !== void 0 ? _v : undefined));
                    ...
                    if (!req.verifiedCourseAuth && launchInfo) {
                        courseContextToken = (_w = req.headers) === null || _w === void 0 ? void 0 : _w[COURSE_CONTEXT_HEADER_1.default.toLowerCase()];
                        if (typeof courseContextToken === 'string' && courseContextToken.length > 0) {
                            try {
                                req.verifiedCourseAuth = (0, courseContext_1.verifyCourseContextToken)({
                    ...
                    verifiedCourseAuth = (req.verifiedCourseAuth);
                    ...
                    // This is a select admin endpoint
                    return [3 /*break*/, 7];
                    return [4 /*yield*/, (0, initExpressKitCollections_1.internalGetSelectAdminCollection)()];
                case 5:
                    selectAdminCollection = _x.sent();
                    id = output.userId;
                    return [4 /*yield*/, selectAdminCollection.find({ id: id })];
                case 6:
                    match = (_x.sent())[0];
                    ...
                    if (!match) {
                        ...
                        return [2 /*return*/, (0, handleError_1.default)(res, {
                                ...
                                code: ExpressKitErrorCode_1.default.NotSelectAdmin,
                                status: 401,
                            })];
                    }
                    _x.label = 7;
                case 7:
                    logServerEvent = function (logOpts) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a, browser, device, _b, timestamp, year, month, day, hour, minute, logIsLearner, logIsTTM, logIsAdmin, logCourseId, logCourseName, mainLogInfo, typeSpecificInfo, sourceSpecificInfo, log, logCollection, err_3, dummyMainInfo, dummyTypeSpecificInfo, dummySourceSpecificInfo, log;
                        ...
                        return __generator(this, function (_r) {
                            switch (_r.label) {
                                case 0:
                                    ...
                                    _b = (0, dce_commonkit_1.getTimeInfoInET)(), timestamp = _b.timestamp, year = _b.year, month = _b.month, day = _b.day, hour = _b.hour, minute = _b.minute;
                                    logIsLearner = !!(verifiedCourseAuth
                                        ? verifiedCourseAuth.isLearner
                                        : (launchInfo && launchInfo.isLearner));
                                    logIsTTM = !!(verifiedCourseAuth
                                        ? verifiedCourseAuth.isTTM
                                        : (launchInfo && launchInfo.isTTM));
                                    logIsAdmin = !!(verifiedCourseAuth
                                        ? verifiedCourseAuth.isAdmin
                                        : (launchInfo && launchInfo.isAdmin));
                                    logCourseId = (verifiedCourseAuth
                                        ? verifiedCourseAuth.courseId
                                        : (launchInfo ? launchInfo.courseId : -1));
                                    logCourseName = ((verifiedCourseAuth && verifiedCourseAuth.courseName !== undefined)
                                    ...
                                    mainLogInfo = {
                                        ...
                                        context: (typeof logOpts.context === 'string'
                                            ? logOpts.context
                                            : ((_d = ((_c = logOpts.context) !== null && _c !== void 0 ? _c : {})._) !== null && _d !== void 0 ? _d : dce_commonkit_1.LogBuiltInMetadata.Context.Uncategorized)),
                                        subcontext: ((_e = logOpts.subcontext) !== null && _e !== void 0 ? _e : dce_commonkit_1.LogBuiltInMetadata.Context.Uncategorized),
                                        tags: ((_f = logOpts.tags) !== null && _f !== void 0 ? _f : []),
                                        level: ((_g = logOpts.level) !== null && _g !== void 0 ? _g : dce_commonkit_1.LogLevel.Info),
                                        metadata: ((_h = logOpts.metadata) !== null && _h !== void 0 ? _h : {}),
                                    };
                                    typeSpecificInfo = (('error' in logOpts && logOpts.error)
                                        ? {
                                            type: dce_commonkit_1.LogType.Error,
                                            errorMessage: (_j = logOpts.error.message) !== null && _j !== void 0 ? _j : 'Unknown message',
                                            errorCode: (_k = logOpts.error.code) !== null && _k !== void 0 ? _k : dce_commonkit_1.CommonKitErrorCode.NoCode,
                                            errorStack: (_l = logOpts.error.stack) !== null && _l !== void 0 ? _l : 'No stack',
                                        }
                                        : {
                                            type: dce_commonkit_1.LogType.Action,
                                            target: ((_m = logOpts.target) !== null && _m !== void 0 ? _m : dce_commonkit_1.LogBuiltInMetadata.Target.NoTarget),
                                            action: ((_o = logOpts.action) !== null && _o !== void 0 ? _o : dce_commonkit_1.LogAction.Unknown),
                                        });
                                    sourceSpecificInfo = (logOpts.overrideAsClientEvent
                                        ? {
                                            source: dce_commonkit_1.LogSource.Client,
                                        }
                                        : {
                                            source: dce_commonkit_1.LogSource.Server,
                                            routePath: req.path,
                                ...
                                case 2:
                                    ...
                                    return [3 /*break*/, 4];
                                case 3:
                                    if (log.type === dce_commonkit_1.LogType.Error) {
                                        // Print to console
                                ...
                                case 5:
                                    ...
                                    dummyMainInfo = {
                                        ...
                                        timestamp: Date.now(),
                                        tags: [],
                                        level: dce_commonkit_1.LogLevel.Warn,
                                        metadata: {},
                                        context: dce_commonkit_1.LogBuiltInMetadata.Context.Uncategorized,
                                        subcontext: dce_commonkit_1.LogBuiltInMetadata.Context.Uncategorized,
                                    };
                    ...
                    renderErrorPage = function (renderOpts) {
                        ...
                        logServerEvent({
                            context: dce_commonkit_1.LogBuiltInMetadata.Context.ServerRenderedErrorPage,
                            error: {
                ...
                case 10:
                    ...
                    if (!responseSent) {
                        ...
                        logServerEvent({
                            context: dce_commonkit_1.LogBuiltInMetadata.Context.ServerEndpointError,
                            error: err_2,
                        });
                        return [2 /*return*/];
                    }
