        ...
        return __generator(this, function (_y) {
            switch (_y.label) {
                ...
                case 4:
                    ...
                    output.userHUID = (launchInfo
                        ? ((_k = output.userHUID) !== null && _k !== void 0 ? _k : launchInfo.userLoginId)
                        : ((_l = output.userHUID) !== null && _l !== void 0 ? _l : undefined));
                    output.userFirstName = (launchInfo
                        ? launchInfo.userFirstName
                        : ((_m = output.userFirstName) !== null && _m !== void 0 ? _m : undefined));
                    output.userLastName = (launchInfo
                        ? launchInfo.userLastName
                        : ((_o = output.userLastName) !== null && _o !== void 0 ? _o : undefined));
                    output.userEmail = (launchInfo
                        ? launchInfo.userEmail
                        : ((_p = output.userEmail) !== null && _p !== void 0 ? _p : undefined));
                    output.userAvatarURL = (launchInfo
                        ? ((_q = launchInfo.userImage) !== null && _q !== void 0 ? _q : 'http://www.gravatar.com/avatar/?d=identicon')
                        : ((_r = output.userAvatarURL) !== null && _r !== void 0 ? _r : undefined));
                    output.isLearner = (launchInfo
                        ? !!launchInfo.isLearner
                        : ((_s = output.isLearner) !== null && _s !== void 0 ? _s : undefined));
                    output.isTTM = (launchInfo
                        ? !!launchInfo.isTTM
                        : ((_t = output.isTTM) !== null && _t !== void 0 ? _t : undefined));
                    output.isAdmin = (launchInfo
                        ? !!launchInfo.isAdmin
                        : ((_u = output.isAdmin) !== null && _u !== void 0 ? _u : undefined));
                    output.courseId = (launchInfo
                        ? ((_v = output.courseId) !== null && _v !== void 0 ? _v : launchInfo.courseId)
                        : ((_w = output.courseId) !== null && _w !== void 0 ? _w : undefined));
                    output.courseName = (launchInfo
                        ? launchInfo.contextLabel
                        : ((_x = output.courseName) !== null && _x !== void 0 ? _x : undefined));
