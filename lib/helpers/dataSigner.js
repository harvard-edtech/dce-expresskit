...
var decrypt = function (encryptedPack) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if (!DCEKIT_CRED_ENCODING_SALT) {
            throw new dce_commonkit_1.ErrorWithCode('Could not decrypt a string because the encryption salt was not set.', ExpressKitErrorCode_1.default.CrossServerNoCredentialEncodingSalt);
        }
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!opts.params.oauth_signature) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request there was no oauth signature.', ExpressKitErrorCode_1.default.CrossServerMissingSignedRequestInfo);
                }
                ...
                !opts.params.oauth_timestamp
                    ...
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request there was no valid oauth timestamp.', ExpressKitErrorCode_1.default.CrossServerMissingSignedRequestInfo);
                }
                timestamp = Number.parseInt(opts.params.oauth_timestamp, 10);
                // Get the key
                if (!opts.params.oauth_consumer_key) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request there was no oauth consumer key.', ExpressKitErrorCode_1.default.CrossServerMissingSignedRequestInfo);
                }
                key = opts.params.oauth_consumer_key;
                method = opts.method, path = opts.path, params = opts.params, scope = opts.scope;
                return [4 /*yield*/, (0, initExpressKitCollections_1.internalGetCrossServerCredentialCollection)()];
            case 1:
                crossServerCredentialCollection = _a.sent();
                if (!crossServerCredentialCollection) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the cross-server credential collection was not ready in time.', ExpressKitErrorCode_1.default.SignedRequestInvalidCollection);
                }
            ...
            case 2:
                ...
                if (!crossServerCredentialMatches || crossServerCredentialMatches.length === 0) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the credential was not found.', ExpressKitErrorCode_1.default.SignedRequestInvalidCredential);
                }
                ...
                if (!allowedScopes || !Array.isArray(allowedScopes)) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the credential does not have access to any scopes.', ExpressKitErrorCode_1.default.SignedRequestInvalidScope);
                }
                if (!allowedScopes.includes(scope)) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the required scope was not approved for the credential.', ExpressKitErrorCode_1.default.SignedRequestInvalidScope);
                }
            ...
            case 4:
                ...
                if (signature !== expectedSignature) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the signature did not match.', ExpressKitErrorCode_1.default.SignedRequestInvalidSignature);
                }
                elapsedMs = Math.abs(Date.now() - timestamp);
                if (elapsedMs > dce_commonkit_1.MINUTE_IN_MS) {
                    throw new dce_commonkit_1.ErrorWithCode('Could not validate a cross-server request because the request was too old.', ExpressKitErrorCode_1.default.SignedRequestInvalidTimestamp);
                }
                return [2 /*return*/];
        }
    });
