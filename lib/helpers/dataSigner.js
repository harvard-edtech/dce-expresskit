...
var validateSignedRequest = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var signature, timestamp, key, method, path, params, scope, crossServerCredentialCollection, crossServerCredentialMatches, crossServerCredential, allowedScopes, secret, expectedSignature, elapsedMs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                /* ---------- Collect Info ---------- */
